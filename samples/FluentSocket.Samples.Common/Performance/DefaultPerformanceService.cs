        ...
        class CountInfo
        {
            ...
            public void Calculate()
            {
                ...
                if (_service._setting.AutoLogging)
                {
                    ...
                    _service._logger.LogInformation("{0}, {1}totalCount: {2}, throughput: {3}, averageThrughput: {4}, rt: {5:F3}ms, averageRT: {6:F3}ms", _service._name, contextText, _totalCount, _throughput, _averageThroughput, _rt, _averateRT);
                }
                if (_service._setting.PerformanceInfoHandler != null)
                {
                    ...
                    {
                        _service._logger.LogError("PerformanceInfo handler execution has exception.", ex);
                    }
                }
            }
